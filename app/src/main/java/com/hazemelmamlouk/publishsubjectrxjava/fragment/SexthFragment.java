...
public class SexthFragment extends Fragment {
    private TextView txtName;
    private PageViewModel pageViewModel;


    public SexthFragment() {
     ...
     */
    public static SexthFragment newInstance() {
        return new SexthFragment();
    }
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sexth, container, false);
    }
