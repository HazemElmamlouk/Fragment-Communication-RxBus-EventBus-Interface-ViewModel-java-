...
public class InterfacePagerAdapter extends FragmentPagerAdapter {
    @StringRes
    private static final int[] TAB_TITLES = new int[] { R.string.tab_text_1, R.string.tab_text_2 };
    private final Context mContext;

    public InterfacePagerAdapter(Context context, FragmentManager fm) {
        super(fm);
        mContext = context;
    }
    ...
    public Fragment getItem(int position) {
        ...
        if (position == 0) {
            return siventhFragment.newInstance();
        } else {
